...
## ..Range is in blocks, so running {/data modify storage blue:beacon main.lvl2Duration set value "1000"} will basically make level 2 beacons give their effects to every entity you can see
