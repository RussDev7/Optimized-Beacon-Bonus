...
execute if data storage blue:beacon main.secondary if score -.double blue.beaconVal matches 1 run function blue:beacon/secondary/level3 with storage blue:beacon main
