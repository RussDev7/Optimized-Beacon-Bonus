...
execute if data storage blue:beacon main.secondary if score -.double blue.beaconVal matches 1 run function blue:beacon/secondary/level4 with storage blue:beacon main
execute unless score -.double blue.beaconVal matches 1 run function blue:beacon/double/level4 with storage blue:beacon main
