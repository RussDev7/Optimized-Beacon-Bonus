...
##  Running "/schedule clear blue_b:repeat" will stop beacons from giving effects to nearby (peaceful) entities.
  ##  "/function blue_b:repeat" will resume beacons giving their effects, at the normal interval specified below.

## If you want to have this datapack detect beacons that were placed before this datapack was added, you can type "/function blue_b:quick_find" to constantly check blocks infront of all players for 30 seconds with a feint indication, adding beacons it collides with.
...
scoreboard players set -.loaded blue_b.beaconVal 1
