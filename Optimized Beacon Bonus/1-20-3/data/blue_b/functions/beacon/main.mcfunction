...
execute if score -.levels blue_b.beaconVal matches 1 run return run function blue_b:beacon/primary/level1 with storage blue:beacon main
execute if score -.levels blue_b.beaconVal matches 2 run return run function blue_b:beacon/primary/level2 with storage blue:beacon main
execute if score -.levels blue_b.beaconVal matches 3 run return run function blue_b:beacon/primary/level3 with storage blue:beacon main
...
execute if score -.double blue_b.beaconVal matches 1 run function blue_b:beacon/secondary with storage blue:beacon main